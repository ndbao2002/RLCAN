from argument.argument_rncan import args
...
from network.RNCAN import RNCAN
...
if __name__ == '__main__':
    ...
    last_trained_path = "/media/btlen03/ndbao/pre_trained_model/RNCAN/current_model.pth"
